...
export const catalog = [
 ...
 {id:'shoemaker-levy-9',key:'comet',name:'Shoemaker-Levy 9 (fragment)',group:'Małe ciała',mass:3e11/SOLAR_MASS,radius:.5,spin:8,tilt:20,color:'#b8c6cc',source:'https://science.nasa.gov/jupiter/comet-shoemaker-levy-9-fragment-b/',note:'Pojedynczy fragment komety rozerwanej przez Jowisza w 1992 roku. W lipcu 1994 dwadzieścia jeden odłamków uderzyło w planetę — pierwsza zderzenie ciał Układu Słonecznego obserwowane na żywo. Rozmiar fragmentu jest oszacowaniem.'},
