...
import {applyCentralStarPreset,blackbodyColor,centralStarDetails,centralStars,starPreset,visualLuminosity} from './central-stars.js';
...
function applySolarBrightness(){
 ...
 const scale=solarBrightness/100*(1-solarInfall*.78),output=visualLuminosity(sun?.luminosity??1)*scale;
