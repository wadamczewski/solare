...
const bs=initialSystem(EPOCH),s=fs.readFileSync(root+'src/main.js','utf8');const code=s.slice(s.indexOf('function mapped('),s.indexOf('const sphere='));const {displayed,radius}=new Function('THREE','bs','AU','sceneRadius','satelliteOffset','const lightFlight=null,systemMode=null,compressed=true,vector=a=>new THREE.Vector3(...a);'+code+';return {displayed,radius}')(THREE,bs,AU,sceneRadius,satelliteOffset);
